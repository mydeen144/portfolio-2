...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <div
                className={cn(
                    'fixed top-0 right-0 h-[100dvh] w-[500px] max-w-[calc(100vw-3rem)] transform translate-x-full transition-transform duration-700 z-[99] overflow-hidden gap-y-14',
            ...
            >
                ...
                <button 
                    onClick={() => setIsMenuOpen(false)}
                    className="absolute top-6 right-6 z-10 size-10 flex items-center justify-center rounded-full bg-background/80 backdrop-blur-sm border border-border shadow-lg transition-all duration-300 hover:scale-110 hover:bg-primary/10"
                                ...
                                {SOCIAL_LINKS.map((link) => (
                                    <li key={link.name}>
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noreferrer"
                                            className="text-lg capitalize hover:underline text-foreground hover:text-primary transition-colors"
                                        >
                                            {link.name}
                                        </a>
                                    </li>
                                ...
                                {MENU_LINKS.map((link, idx) => (
                                    <li key={link.name}>
                                        <button
                                            ...
                                            className="group text-xl flex items-center gap-3 text-foreground hover:text-primary transition-colors"
                                        >
                                            <span
                                                className={cn(
                ...
                <div className="w-full max-w-[300px] mx-8 sm:mx-auto">
                    ...
                    <a href={`mailto:${GENERAL_INFO.email}`} className="text-foreground hover:text-primary transition-colors">
                        {GENERAL_INFO.email}
                    </a>
                </div>
            </div>
